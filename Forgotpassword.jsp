...
<button onclick="myFunction2()" class="dropbtn2">Reports&#9207</button>
  <div id="myDropdown2" class="dropdown-content2">
    ...
    <a href="Adminlogin.jsp">Update DB</a>
     ...
     <br><br><br>
     <form name="Login" action="http://localhost:8081/JES/SendMailServlet" onsubmit="return loginValidation()" method="post">
		<center style="font-size:75%;">
		<p style="color:red;">${mailfailure}${pswdchngfailure}${pswdexp} </p><br />
